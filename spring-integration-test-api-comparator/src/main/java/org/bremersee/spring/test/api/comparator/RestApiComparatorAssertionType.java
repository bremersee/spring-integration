 ...
 */
@Getter
public enum RestApiComparatorAssertionType {
  ...
  private final RestApiComparatorAssertionType parent;

  RestApiComparatorAssertionType(RestApiComparatorAssertionType parent) {
    this.parent = parent;
  }
}
