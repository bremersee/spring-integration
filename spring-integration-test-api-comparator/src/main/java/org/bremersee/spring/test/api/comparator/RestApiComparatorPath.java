...
public interface RestApiComparatorPath {
  ...
  interface Builder {
     ...
     */
    RestApiComparatorPath build();
  }

  /**
   * The rest api tester path implementation.
   */
  class Impl extends ArrayList<RestApiTesterPathValues> implements RestApiComparatorPath {
  ...
  class BuilderImpl implements Builder {
    ...
    @Override
    public RestApiComparatorPath build() {
