...
public interface GoodRestApiOne {
  ...
  ResponseEntity<ExampleModel> addExampleModel(
  ...
  @RequestMapping(
      ...
      produces = {"application/json"},
      method = RequestMethod.GET)
  ResponseEntity<ExampleModel> getExampleModel(
  ...
  ResponseEntity<ExampleModel> updateExampleModel(
      @Parameter(description = "The model ID.", required = true) @PathVariable("id") String id,
      @Parameter(description = "The model.", required = true)
      @RequestBody ExampleModel model);
  ...
  ResponseEntity<Void> deleteExampleModel(
      @Parameter(description = "The model ID.", required = true) @PathVariable("id") String id);
